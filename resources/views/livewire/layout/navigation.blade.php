        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->check() ? route('dashboard') : route('products') }}" wire:navigate>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 hover:text-gray-900 px-3 py-2 bg-gray-200 rounded-md">Register</a>
                @endauth
            </div>
